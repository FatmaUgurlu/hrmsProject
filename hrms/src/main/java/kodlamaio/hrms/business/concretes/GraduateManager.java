...
public class GraduateManager implements GraduateService{
	...
	public Result add(Graduate graduate) {
		if(graduateDao.existsByDescription(graduate.getDescription())) {
			return new ErrorResult("Daha önce eklenmiş bir mezuniyet bilgisidir.");
		}
	...
	public DataResult<List<Graduate>> getAll() {
		...
		return new SuccessDataResult<List<Graduate>>(this.graduateDao.findAll(), "Mezuniyetler listelendi.");
	}
